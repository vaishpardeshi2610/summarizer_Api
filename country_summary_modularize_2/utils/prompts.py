...
# Add the new COUNTRY_SUMMARY_PROMPT
COUNTRY_SUMMARY_PROMPT = """
Generate a concise summary for {country_name} based on the following data:
Surface Area: {surface_area} sq km
Exports: ${exports} billion
Annual Tourists: {tourists} million
GDP: ${gdp} billion
...
def get_prompt_for_parameter(parameter):
    prompts = {
        ...
        "country_summary": COUNTRY_SUMMARY_PROMPT,  # Add this line
    }
